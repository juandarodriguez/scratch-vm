...
console.log('adding storage event');
let brain = function(text){
  return "no tengo modelo aún";
};
...
window.addEventListener("message", e => {
  ...
  console.log(e);
  code = e.data;
  brain = new Function("rawInput", "maxPredictionLength", "isSampleI", "temperature", code);
  console.log(brain);
});
